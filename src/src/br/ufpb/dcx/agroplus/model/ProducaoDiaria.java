...
public class ProducaoDiaria {
    ...
    public Relatorio getRelatorioProducao() {
        ...
        String conteudoTexto = String.format("Relatorio de Producao do Lote %s na data %s:\nQuantidade de ovos produzidos: %d\nObservacoes: %s", this.lote, this.data, this.quantidadeOvos, this.observacoes);
        return new Relatorio(this.id, "Producao", LocalDate.now(), params, conteudoTexto.getBytes());
    }
