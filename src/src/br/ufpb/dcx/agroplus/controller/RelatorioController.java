...
public class RelatorioController {
    ...
    public RelatorioController() { this.repository = DadosRepository.getInstance(); }
    public List<Relatorio> listarRelatoriosGerados() { return repository.getRelatorios(); }

    public void gerarRelatorio(String tipo, String descricaoAdicional) {
        if (!AuthController.hasPermission("GERAR_RELATORIOS")) throw new SecurityException("Acesso negado: Apenas administradores (patrão) podem gerar relatórios.");
